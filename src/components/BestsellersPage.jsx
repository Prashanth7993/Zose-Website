...
export default function BestsellersPage({ products = [], isLoading = false }) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-8 sm:py-10 lg:py-12">
      <div className="text-center mb-8">
        <p className="text-[10px] sm:text-[11px] tracking-[0.22em] uppercase text-[#C9A14A] mb-2">Most Popular</p>
        ...
        <div>
          ...
          >
            <p className="text-[13px] sm:text-[14px] text-[#333333]">
              {filteredProducts.length} bestseller{filteredProducts.length === 1 ? "" : "s"}
            </p>
          ...
          {!filteredProducts.length && !isLoading && (
            <div className="text-center py-16">
              ...
              <p className="text-[12px] text-[#888888] mt-2">Check back soon for our popular picks</p>
            </div>
          )}
        </div>
      </div>
